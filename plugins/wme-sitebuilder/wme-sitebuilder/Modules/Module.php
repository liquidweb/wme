...
abstract class Module {
	...
	public function register_hooks() {
		...
		add_action( 'admin_head', [ $this, 'action__site_visibility_bar' ] );
		add_action( 'admin_head', [ $this, 'add_site_visibility_styles' ] );
	}
	 ...
	 * @return void
	 */
	public function action__site_visibility_bar() {
	...
	protected function get_site_visibility() {
		// TODO: Get site visibility status
	 ...
	 * @return void
	 */
	public function add_site_visibility_styles() {
